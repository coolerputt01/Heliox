    ...
    <main aria-label="Page Sliders">
      <div class="slider-container">
        <section class="slider1 zoom-active">
          <img :src="getStarted" class="slider-img" alt="Getting Started" />
          <h2 class="slider-head fade-to-bottom">Welcome to Heliox</h2>
          <p class="slider-desc fade-to-bottom">
            Looking for a better experience and approach with task management
            and task completions? Let's get you fired up!
          </p>
        </section>
        <section class="slider2">
          ...
          <h2 class="slider-head fade-to-bottom">
            Track your commitment daily
          </h2>
          <p class="slider-desc fade-to-bottom">
            If you have ever had issues keep track of your daily streak
            activities, <b>Heliox</b> is the one in all app you need!
          </p>
        </section>
        <section class="slider3">
          <img :src="organise" class="slider-img" alt="Organise" />
        ...
        <section class="slider4">
          <img :src="letsgo" class="slider-img" alt="Lets Go" />
